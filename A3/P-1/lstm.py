...
model = lstm(batch_size,embedding_dim, word2vec_model, num_hidden_units, num_output_units, n_layers, True, dropout)
model.init_weights()
...
#join all tokens in text but dont join pad tokens ''
